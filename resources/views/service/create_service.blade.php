    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card w-50">
            <div class="card-header pb-0">
                <h6>{{ isset($service) ? 'Edit Service' : 'Create Service' }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ isset($service) ? route('service.update', $service->id) : route('service.store') }}"
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4"
                            placeholder="Enter service description...">{{ isset($service) ? $service->description : old('description') }}</textarea>
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        @if (isset($service) && $service->image)
                            <input type="hidden" name="old_photo" value="{{ $service->image }}">

                            <div class="mt-2">
                                <img src="{{ asset('images/services/' . $service->image) }}" alt="Profile Image"
