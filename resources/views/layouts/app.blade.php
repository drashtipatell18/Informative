...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('assets/img/logo__2.png') }}" sizes="32x32">
    <link rel="icon" type="image/png" href="{{ asset('assets/img/logo__2.png') }}" sizes="16x16">
    <link rel="shortcut icon" href="{{ asset('assets/img/logo__2.png') }}">
    <title>
        Shreenathjitourism
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('footer_description*') ? 'active' : '' }}"
                        href="{{ route('footer_description') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-image text-dark text-sm opacity-10"></i>
                        </div>
